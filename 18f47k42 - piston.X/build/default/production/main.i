...
# 557 "./mcc_generated_files/smt1.h"
void SMT1_PR_ACQ_ISR(void);
# 573 "./mcc_generated_files/smt1.h"
...
void main(void) {
    ...
    switch (mody) {
        case 0: for (int j = 0; j <= 5; j++) {
            ...
            _delay((unsigned long)((35000)*(500000/4000.0)));
            ...
            break;
        case 1: _delay((unsigned long)((500)*(500000/4000.0)));
            break;
        case 2: _delay((unsigned long)((500)*(500000/4000.0)));
            break;
    }
