...
/*
  Name:       Piston_Winch_Pump_controller-2.6
  Date:       21 July 2021
  Brief:
...
***********************************************************************************************
  ...
  mody =2:  Winch - proportional. On power-on, starting in low-stick position, winds in for 10 seconds. No limit switches but needs slipping clutch.
  Make sure that you set mody to mode you want.

  TESTING H BRIDGE
  Put in mody = 1 for pump mode. Connect board to 12v battery and 12v motor. Plug in USB cable. (No need for radio or Hall input.) Motor shoould give brief blip and then reverse and run continuosly. Monitor Serial Monitor to check the Arduino.
